...
The rest of the improvement list is unchanged in kind: continuous fuzzing, and payload schemas in the OpenAPI contract. None is a release blocker. Provenance is built and tested but has not yet ridden a release.
