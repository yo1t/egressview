...
describe('repository public assets', () => {
  ...
  it('keeps Pages source separate from application and package roots', () => {
    // sitemap.xml is not listed: it is generated by jekyll-sitemap at build
    // time. A file here would override the generated one and go stale as soon
    // as a page is added, which is how the published sitemap came to list two
    // URLs for a site serving more than forty.
    for (const file of ['index.html', 'index.ja.html', '_config.yml', '_config.www.yml']) {
