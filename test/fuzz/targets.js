// The parsers that read untrusted external input, and how to call them.
//
// One table, used by the PR-gate test and by the continuous runner. Two lists
// would drift, and the run that found nothing would be the one aimed at
// something else.
'use strict';
